<aside class="sidebar" id="sidebar">
    ...
    <nav>
        @if(auth()->user()->isAdmin())
            ...
            <a href="/admin/data" data-nav="data" title="Dữ liệu & sao lưu"><span class="nav-icon"><svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><ellipse cx="12" cy="5" rx="8" ry="3"></ellipse><path d="M4 5v6c0 1.7 3.6 3 8 3s8-1.3 8-3V5"></path><path d="M4 11v6c0 1.7 3.6 3 8 3s8-1.3 8-3v-6"></path></svg></span><span class="nav-label">Dữ liệu & sao lưu</span></a>
        @else
            <p>VẬN HÀNH</p>
